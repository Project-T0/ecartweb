...
if (isset($_POST['btnAdd'])) {
    ...
    if ($permissions['products']['create'] == 1) {
        ...
        if (!empty($name) && !empty($category_id) && !empty($serve_for) && empty($error['size_chart']) && empty($error['other_images']) && empty($error['image']) && empty($error['cancelable']) && !empty($description) && !empty($shipping_delivery)) {
            $string = '0123456789';
                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="form-group packate_div">
                                        ...
                                        <input type="number" step="any" min="0" class="form-control measurement" name="packate_measurement[]" required />
                                    </div>
                                </div>
                                <div class="col-md-1">
                                    <div class="form-group packate_div">
...
<script>
    ...
    $('#add_packate_variation').on('click', function() {
        html = '<div class="row"><div class="col-md-2"><div class="form-group"><label for="measurement">Measurement</label> <i class="text-danger asterik">*</i>' +
            ...
            '<label for="measurement_unit">Unit</label><select class="form-control units" name="packate_measurement_unit_id[]">' +
            '<?php
                foreach ($res_unit as $row) {
                    echo "<option value=" . $row['id'] . ">" . $row['short_code'] . "</option>";
                }
