...
7. if your system updated successfully,
	...
	--> please change config/ekart.php
		'home_url' => env("APP_URL", "https:/webekart.wrteam.in/"),
		'api_url' => env("API_URL", "https:/newekart.wrteam.in/api-firebase/"),
		'asset_url' => env("ASSET_URL1", "https://newekart.wrteam.in/dist/img/"),
		
		Also check your key = 'jwt_secret_key' => env("JWT_SECRET_KEY", "replace_with_your_strong_jwt_secret_key"),
