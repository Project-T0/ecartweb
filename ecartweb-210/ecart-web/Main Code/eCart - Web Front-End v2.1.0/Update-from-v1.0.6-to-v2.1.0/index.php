            ...
            <div class="site-wrapper-inner">
                <div class="cover-container">
                    ...
                    <div class="inner cover">
                        ...
                        <p class="lead">This is an Automatic Updater which helps you update your Web eCart Website Code From v<?=$current_version;?> to v<?=$latest_version;?> </p>
                        <p>
							<b>Please note</b> : Use this script only when, you have <b><?=$app_name;?> v<?=$current_version;?> Website</b> installed on your server. <span style='color: #d2120e;'>Ignore this if you are starting it freshly from scratch.</span>
						...
						<p>
                            <a href="https://codecanyon.net/item/ecart-web/29260418" target='_blank' class="btn btn-lg btn-default">See What's New Here</a>
                        </p>
                    </div>
                    <div class="mastfoot">
                        <div class="inner">
